...
<meta name="bingbot" content="noindex, nofollow">
    ...
    <title>Elara - Silver Ant Marketing</title>
    ...
    <script>
        ...
        function startNewChat() {
            ...
            const newThread = {
                ...
                messages: [{
                    role: 'system',
                    content: 'Hello! I am Elara the Silver Ant\'s AI Assistant, ready to assist with Silver Ant Marketing operations. How can I help you today?',
                    timestamp: Date.now()
                }]
            };
